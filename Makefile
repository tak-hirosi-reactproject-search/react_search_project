...
run:
	@echo 'docker run -ti --name="$(APP_NAME)" -p 3000:3000 --shm-size 32gb -v $(MODEL_VOLUME) $(IMAGE_NAME)'
	docker run -ti --name="$(APP_NAME)" -p 3000:3000 --shm-size  32gb -v $(MODEL_VOLUME) $(IMAGE_NAME)

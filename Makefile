...
run:
	@echo 'docker run -ti --name="$(APP_NAME)_$(USR)" --shm-size 32gb -p 3000:3000 -v $(MODEL_VOLUME) $(IMAGE_NAME)'
	docker run -ti --name="$(APP_NAME)_$(USR)" --shm-size 32gb -p 3000:3000 -v $(MODEL_VOLUME) $(IMAGE_NAME)
stop:
